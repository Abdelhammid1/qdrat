...
{
    public class LearningStatusController : ParentBaseController
    {
        private readonly IParentSafeInsightService _insightService;

        public LearningStatusController(
        ...
        public async Task<IActionResult> Index(int? studentId)
        {
            ...
            var vm = await _insightService.GetLearningStatusAsync(ParentId, sid);
            return View(vm);
        }
    }
}
